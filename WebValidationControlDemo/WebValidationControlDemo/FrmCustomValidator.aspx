<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrmCustomValidator.aspx.cs" Inherits="WebValidationControlDemo.FrmCustomValidator" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:CustomValidator ID="CustomValidator1" runat="server" 
                ...
                ></asp:CustomValidator>
            <hr />
            <asp:ImageButton ID="btnSubmit" runat="server" Text="확인"/>
        </div>
    </form>
</body>
</html>
